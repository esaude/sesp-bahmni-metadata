...
update test set uom_id=(select id from unit_of_measure where name='mmol/l') where description IN ('CÁLCIO (2. 122.62 mmol/L)','COLESTER (3,9-6,7 mmol/L)','FOSF.INOR. (0-77-1.36 mmol/L)','GLICEMIA (3.05-6.05 mmol/L) ','LIP. TOTAIS (4.0-10 mmol/L)','POTÁSSIO (3.3-5.6 mmol/L)','TRIGLICER (0,6-2,23 mmol/L) ','CLORETOS (96-110 mmol/L) ','UREIA (3.3-6.7 mmol/L)') ;
